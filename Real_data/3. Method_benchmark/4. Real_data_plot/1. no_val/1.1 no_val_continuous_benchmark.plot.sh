...
EAS_p <- ggplot(long_table[which(long_table$pop == "EAS"),], aes(x = trait, y = r2, group = method, fill = method)) +
...
AFR_p <- ggplot(long_table[which(long_table$pop == "AFR"),], aes(x = trait, y = r2, group = method, fill = method)) +
    geom_bar(stat = "identity", position = "dodge") +
    geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
    scale_fill_manual(values = auto_method_color) +
    facet_grid(~ pop, scales = "free_x", space = "free_x") +
...
SAS_p <- ggplot(long_table[which(long_table$pop == "SAS"),], aes(x = trait, y = r2, group = method, fill = method)) +
    geom_bar(stat = "identity", position = "dodge") +
    geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
    scale_fill_manual(values = auto_method_color) +
    facet_grid(~ pop, scales = "free_x", space = "free_x") +
...
AMR_p <- ggplot(long_table[which(long_table$pop == "AMR"),], aes(x = trait, y = r2, group = method, fill = method)) +
    geom_bar(stat = "identity", position = "dodge") +
    geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
    scale_fill_manual(values = auto_method_color) +
    facet_grid(~ pop, scales = "free_x", space = "free_x") +
