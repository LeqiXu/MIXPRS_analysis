# SDPRX
# Step1.1 subsample_full [dsq job: 48464586; 48464593]
job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_full_Binary_PRS3.txt"
...
sample_size1=88825; sample_size2=88870; rho=0.87
elif [[ ${pop2} == "AFR" && ${trait} == "T2D" ]]; then
sample_size1=88825; sample_size2=29189; rho=0.99
elif [[ ${pop2} == "EAS" && ${trait} == "BrC" ]]; then
sample_size1=245620; sample_size2=20354; rho=0.88
elif [[ ${pop2} == "AFR" && ${trait} == "BrC" ]]; then
sample_size1=245620; sample_size2=5576; rho=0.17
else
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_full_Binary_PRS3.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_full_Binary_PRS3-$(date +%Y-%m-%d).sh

job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_full_Binary_PRS2.txt"
> $job_file  # Empty the job file if it already exists
...
sample_size1=61333; sample_size2=75819; rho=0.79
elif [[ ${pop2} == "EAS" && ${trait} == "LuC" ]]; then
sample_size1=77095; sample_size2=11918; rho=0.99
else
echo "Please provide the available phenotype"
fi
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_full_Binary_PRS2.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_full_Binary_PRS2-$(date +%Y-%m-%d).sh

# Step1.2 subsample_prune [dsq job: 48464596; 48464599]
job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_prune_Binary_PRS3.txt"
> $job_file  # Empty the job file if it already exists
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_prune_Binary_PRS3.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_prune_Binary_PRS3-$(date +%Y-%m-%d).sh


job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_prune_Binary_PRS2.txt"
> $job_file  # Empty the job file if it already exists
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_prune_Binary_PRS2.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
