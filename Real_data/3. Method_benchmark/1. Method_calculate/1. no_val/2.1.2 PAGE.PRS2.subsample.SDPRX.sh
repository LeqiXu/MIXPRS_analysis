# SDPRX
# Step1.1 subsample_full [dsq job: 18575727]
job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_full_PAGE_PRS.txt"
...
sample_size1=252357; sample_size2=119321; rho=0.87
elif [[ ${pop2} == "AFR" && ${trait} == "Height" ]]; then
sample_size1=252357; sample_size2=37336; rho=0.99
elif [[ ${pop2} == "EAS" && ${trait} == "BMI" ]]; then
sample_size1=233787; sample_size2=118713; rho=0.84
elif [[ ${pop2} == "AFR" && ${trait} == "BMI" ]]; then
sample_size1=233787; sample_size2=37001; rho=0.99
elif [[ ${pop2} == "EAS" && ${trait} == "SBP" ]]; then
sample_size1=728893; sample_size2=134250; rho=0.68
elif [[ ${pop2} == "AFR" && ${trait} == "SBP" ]]; then
sample_size1=728893; sample_size2=26575; rho=0.99
elif [[ ${pop2} == "EAS" && ${trait} == "DBP" ]]; then
sample_size1=746038; sample_size2=134250; rho=0.72
elif [[ ${pop2} == "AFR" && ${trait} == "DBP" ]]; then
sample_size1=746038; sample_size2=26575; rho=0.99
elif [[ ${pop2} == "EAS" && ${trait} == "PLT" ]]; then
sample_size1=539667; sample_size2=134250; rho=0.83
elif [[ ${pop2} == "AFR" && ${trait} == "PLT" ]]; then
sample_size1=539667; sample_size2=21996; rho=0.99
else
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/SDPRX/subsample_full_PAGE_PRS.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_full_PAGE_PRS-$(date +%Y-%m-%d).sh



# Step1.2 subsample_prune [dsq job: 18575728]
