...
for(pop in c("EAS","AFR")){
    ...
    glm_PRScsx_phiauto_val = glm(pheno ~ . + 0, data = Trait_PRScsx_phiauto_val[,c(2:5)],family=binomial(link="logit"))
    glm_PRScsx_phi1e_06_val = glm(pheno ~ . + 0, data = Trait_PRScsx_phi1e_06_val[,c(2:5)],family=binomial(link="logit"))
    glm_PRScsx_phi1e_04_val = glm(pheno ~ . + 0, data = Trait_PRScsx_phi1e_04_val[,c(2:5)],family=binomial(link="logit"))
    glm_PRScsx_phi1e_02_val = glm(pheno ~ . + 0, data = Trait_PRScsx_phi1e_02_val[,c(2:5)],family=binomial(link="logit"))
    glm_PRScsx_phi1e_00_val = glm(pheno ~ . + 0, data = Trait_PRScsx_phi1e_00_val[,c(2:5)],family=binomial(link="logit"))
