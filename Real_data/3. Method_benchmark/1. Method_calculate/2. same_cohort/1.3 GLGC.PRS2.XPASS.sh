...
for (pop2 in c("AFR","SAS")){

pop1="EUR"

file_path = paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/same_cohort/XPASS/",trait,"_XPASS_val_",s,"_EUR_",pop2,"_beta_",pop2,".txt")
...
glm_pop2 <- paste0('/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/summary_data/XPXP/',trait,'_',pop2,'_inter_UKB_val_',s,'_XPXP.txt') # target
...
write.table(final_beta, file=paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/same_cohort/XPASS/",trait,"_XPASS_val_",s,"_EUR_",pop2,"_beta_",pop2,".txt"), row.names=F, col.names=T, quote=F, append=F)
}
}
}
}