...
--pop1_test_data /gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ukbb_data/pheno_data/${trait}/${trait}_${pop1}_doubleidname.tsv \
--pop2_test_data /gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ukbb_data/pheno_data/${trait}/split/${trait}_${pop2}_val_${s}_doubleidname.tsv \
