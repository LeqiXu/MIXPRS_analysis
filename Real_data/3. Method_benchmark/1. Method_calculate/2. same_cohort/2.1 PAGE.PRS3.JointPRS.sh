...
# sample size
if [[ ${trait} == "Height" && ${s} == "1" ]]; then
sample_size1=252357; sample_size2=159095; sample_size3=54911
elif [[ ${trait} == "BMI" && ${s} == "1" ]]; then
sample_size1=233787; sample_size2=158284; sample_size3=54456
elif [[ ${trait} == "SBP" && ${s} == "1" ]]; then
sample_size1=728893; sample_size2=179000; sample_size3=40448
elif [[ ${trait} == "DBP" && ${s} == "1" ]]; then
sample_size1=746038; sample_size2=179000; sample_size3=40447
elif [[ ${trait} == "PLT" && ${s} == "1" ]]; then
sample_size1=539667; sample_size2=179000; sample_size3=34244
elif [[ ${trait} == "Height" && ${s} == "2" ]]; then
sample_size1=252357; sample_size2=159095; sample_size3=54910
elif [[ ${trait} == "BMI" && ${s} == "2" ]]; then
sample_size1=233787; sample_size2=158284; sample_size3=54456
elif [[ ${trait} == "SBP" && ${s} == "2" ]]; then
sample_size1=728893; sample_size2=179000; sample_size3=40447
elif [[ ${trait} == "DBP" && ${s} == "2" ]]; then
sample_size1=746038; sample_size2=179000; sample_size3=40448
elif [[ ${trait} == "PLT" && ${s} == "2" ]]; then
sample_size1=539667; sample_size2=179000; sample_size3=34245
elif [[ ${trait} == "Height" && ${s} == "3" ]]; then
sample_size1=252357; sample_size2=159095; sample_size3=54912
elif [[ ${trait} == "BMI" && ${s} == "3" ]]; then
sample_size1=233787; sample_size2=158284; sample_size3=54455
elif [[ ${trait} == "SBP" && ${s} == "3" ]]; then
sample_size1=728893; sample_size2=179000; sample_size3=40448
elif [[ ${trait} == "DBP" && ${s} == "3" ]]; then
sample_size1=746038; sample_size2=179000; sample_size3=40448
elif [[ ${trait} == "PLT" && ${s} == "3" ]]; then
sample_size1=539667; sample_size2=179000; sample_size3=34245
elif [[ ${trait} == "Height" && ${s} == "4" ]]; then
sample_size1=252357; sample_size2=159095; sample_size3=54911
elif [[ ${trait} == "BMI" && ${s} == "4" ]]; then
sample_size1=233787; sample_size2=158284; sample_size3=54456
elif [[ ${trait} == "SBP" && ${s} == "4" ]]; then
sample_size1=728893; sample_size2=179000; sample_size3=40448
elif [[ ${trait} == "DBP" && ${s} == "4" ]]; then
sample_size1=746038; sample_size2=179000; sample_size3=40448
elif [[ ${trait} == "PLT" && ${s} == "4" ]]; then
sample_size1=539667; sample_size2=179000; sample_size3=34243
elif [[ ${trait} == "Height" && ${s} == "5" ]]; then
sample_size1=252357; sample_size2=159095; sample_size3=54911
elif [[ ${trait} == "BMI" && ${s} == "5" ]]; then
sample_size1=233787; sample_size2=158284; sample_size3=54456
elif [[ ${trait} == "SBP" && ${s} == "5" ]]; then
sample_size1=728893; sample_size2=179000; sample_size3=40448
elif [[ ${trait} == "DBP" && ${s} == "5" ]]; then
sample_size1=746038; sample_size2=179000; sample_size3=40449
elif [[ ${trait} == "PLT" && ${s} == "5" ]]; then
sample_size1=539667; sample_size2=179000; sample_size3=34244
else
...
for chr in {1..22}; do
if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/same_cohort/JointPRS/${trait}_EUR_EAS_AFR_JointPRS_meta_val_${s}_AFR_pst_eff_a1_b0.5_phiauto_chr${chr}.txt" ]]; then
        sbatch <<EOT
#!/bin/bash
...
#SBATCH --job-name=${trait}_EUR_EAS_AFR_JointPRS_meta_val_${s}_chr${chr}
#SBATCH --output=out_${trait}_EUR_EAS_AFR_JointPRS_meta_val_${s}_chr${chr}.txt
...
--sst_file=data/summary_data/PRScsx/${trait}_EUR_inter_PRScsx.txt,data/summary_data/PRScsx/${trait}_EAS_inter_PRScsx.txt,data/summary_data/PRScsx/${trait}_AFR_inter_UKB_val_${s}_PRScsx.txt \
--rho_cons=1,1,1 \
--n_gwas=${sample_size1},${sample_size2},${sample_size3} \
--chrom=${chr} \
--pop=EUR,EAS,AFR \
--out_dir=result/summary_result/same_cohort/JointPRS \
--out_name=${trait}_EUR_EAS_AFR_JointPRS_meta_val_${s}
...
for(i in 1:22){
    JointPRS_pop_chr <- fread(paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/same_cohort/JointPRS/",trait,"_EUR_EAS_AFR_JointPRS_meta_val_",s,"_",pop,"_pst_eff_a1_b0.5_phiauto_chr",i,".txt"))
...
write.table(JointPRS_all,paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/same_cohort/JointPRS_meta/",trait,"_JointPRS_meta_val_",s,"_EUR_EAS_AFR_beta_",pop,".txt"),quote=F,sep='\t',row.names=F,col.names=T)
...
if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/same_cohort/JointPRS/${trait}_EUR_EAS_AFR_JointPRS_AFR_pst_eff_a1_b0.5_phi${param_phi}_chr${chr}.txt" ]]; then
        sbatch <<EOT
#!/bin/bash
#SBATCH --partition=scavenge,day,week
#SBATCH --requeue
...
for(pop in c("EAS","AFR")){
    ...
    write.table(R2_sub,paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/same_cohort/JointPRS_meta/",trait,"_JointPRS_meta_val_",s,"_EUR_EAS_AFR_r2_",pop,".txt"),quote=F,sep='\t',row.names=F,col.names=T)
    write.table(R2_full,paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/same_cohort/JointPRS_tune/",trait,"_JointPRS_linear_val_",s,"_EUR_EAS_AFR_r2_",pop,".txt"),quote=F,sep='\t',row.names=F,col.names=T)
