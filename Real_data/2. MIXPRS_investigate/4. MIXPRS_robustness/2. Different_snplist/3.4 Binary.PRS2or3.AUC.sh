...
write.table(prs_table,paste0("/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/evaluation/Binary_3_MIX_prune_PRS_AUC_diff_snplists.csv"),quote=F,sep='\t',row.names=F,col.names=T)
...
write.table(prs_table,paste0("/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/evaluation/Binary_2_MIX_prune_PRS_AUC_diff_snplists.csv"),quote=F,sep='\t',row.names=F,col.names=T)