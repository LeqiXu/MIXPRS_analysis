...
job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_full_Binary_3_linear_weights_full_vs_prune.txt"
...
if [[ ! -e ${output_file} ]]; then
    echo "module load miniconda; conda activate py_env; cd /gpfs/gibbs/pi/zhao/lx94/SWIFT/; python /gpfs/gibbs/pi/zhao/lx94/SWIFT/method/MIXPRS/MIX_linear_weight.py --ref_dir=/gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ref_data/PRScsx/1kg --sst_file=data/summary_data/subsample/MIX/${trait}_full_snplist_${pop}_tune_MIX_approxFALSE_ratio3.00_repeat${rpt}.txt --pop=${pop} --prs_beta_file=result/summary_result/JointPRS/${trait}_EUR_subEAS_AFR_JointPRS_${GWAS_type}_repeat${rpt}_beta_${pop2}.txt,result/summary_result/SDPRX/${trait}_${pop1}_${pop2}_SDPRX_${GWAS_type}_repeat${rpt}_beta_${pop2}.txt --indep_approx=${approx} --selection_criterion=${selection_criterion} --non_negative_weights=${non_negative_weights} --out_dir=result/summary_result/Final_weight/no_val --out_name=${trait}_JointPRS_SDPRX_${pop2}_${GWAS_type}_repeat${rpt}" >> $job_file
fi

output_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_repeat${rpt}_${pop}_linear_weights_approx${approx}.txt"

if [[ ! -e ${output_file} ]]; then
    echo "module load miniconda; conda activate py_env; cd /gpfs/gibbs/pi/zhao/lx94/SWIFT/; python /gpfs/gibbs/pi/zhao/lx94/SWIFT/method/MIXPRS/MIX_linear_weight.py --ref_dir=/gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ref_data/PRScsx/1kg --sst_file=data/summary_data/subsample/MIX/${trait}_full_snplist_${pop}_tune_MIX_approxFALSE_ratio3.00_repeat${rpt}.txt --pop=${pop} --prs_beta_file=result/summary_result/JointPRS/${trait}_EUR_subEAS_AFR_JointPRS_${GWAS_type}_repeat${rpt}_beta_EUR.txt,result/summary_result/JointPRS/${trait}_EUR_subEAS_AFR_JointPRS_${GWAS_type}_repeat${rpt}_beta_EAS.txt,result/summary_result/JointPRS/${trait}_EUR_subEAS_AFR_JointPRS_${GWAS_type}_repeat${rpt}_beta_AFR.txt,result/summary_result/SDPRX/${trait}_${pop1}_${pop2}_SDPRX_${GWAS_type}_repeat${rpt}_beta_EUR.txt,result/summary_result/SDPRX/${trait}_${pop1}_EAS_SDPRX_${GWAS_type}_repeat${rpt}_beta_EAS.txt,result/summary_result/SDPRX/${trait}_${pop1}_AFR_SDPRX_${GWAS_type}_repeat${rpt}_beta_AFR.txt --indep_approx=${approx} --selection_criterion=${selection_criterion} --non_negative_weights=${non_negative_weights} --out_dir=result/summary_result/Final_weight/no_val --out_name=${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_repeat${rpt}" >> $job_file
fi
...
if [[ ! -e ${output_file} ]]; then
    echo "module load miniconda; conda activate py_env; cd /gpfs/gibbs/pi/zhao/lx94/SWIFT/; python /gpfs/gibbs/pi/zhao/lx94/SWIFT/method/MIXPRS/MIX_linear_weight.py --ref_dir=/gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ref_data/PRScsx/1kg --sst_file=data/summary_data/subsample/MIX/${trait}_full_snplist_${pop}_tune_MIX_approxFALSE_ratio3.00_repeat${rpt}.txt --pop=${pop} --prs_beta_file=result/summary_result/JointPRS/${trait}_EUR_EAS_subAFR_JointPRS_${GWAS_type}_repeat${rpt}_beta_${pop2}.txt,result/summary_result/SDPRX/${trait}_${pop1}_${pop2}_SDPRX_${GWAS_type}_repeat${rpt}_beta_${pop2}.txt --indep_approx=${approx} --selection_criterion=${selection_criterion} --non_negative_weights=${non_negative_weights} --out_dir=result/summary_result/Final_weight/no_val --out_name=${trait}_JointPRS_SDPRX_${pop2}_${GWAS_type}_repeat${rpt}" >> $job_file
fi
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_full_Binary_3_linear_weights_full_vs_prune.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_full_Binary_3_linear_weights_full_vs_prune-$(date +%Y-%m-%d).sh


job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_full_Binary_2_linear_weights_full_vs_prune.txt"
> $job_file  # Empty the job file if it already exists
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_full_Binary_2_linear_weights_full_vs_prune.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_full_Binary_2_linear_weights_full_vs_prune-$(date +%Y-%m-%d).sh


# Step1.2: subsample_prune [dsq job: ]
job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_3_linear_weights_full_vs_prune.txt"
> $job_file  # Empty the job file if it already exists
...
if [[ ! -e ${output_file} ]]; then
    echo "module load miniconda; conda activate py_env; cd /gpfs/gibbs/pi/zhao/lx94/SWIFT/; python /gpfs/gibbs/pi/zhao/lx94/SWIFT/method/MIXPRS/MIX_linear_weight.py --ref_dir=/gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ref_data/PRScsx/1kg --sst_file=data/summary_data/subsample/MIX/${trait}_prune_snplist_${i}_${pop}_tune_MIX_approx${approx}_ratio3.00_repeat${rpt}.txt --pop=${pop} --prs_beta_file=result/summary_result/JointPRS/${trait}_EUR_subEAS_AFR_JointPRS_${GWAS_type}_${i}_approx${approx}_repeat${rpt}_beta_${pop2}.txt,result/summary_result/SDPRX/${trait}_${pop1}_${pop2}_SDPRX_${GWAS_type}_${i}_approx${approx}_repeat${rpt}_beta_${pop2}.txt --indep_approx=${approx} --selection_criterion=${selection_criterion} --non_negative_weights=${non_negative_weights} --out_dir=result/summary_result/Final_weight/no_val --out_name=${trait}_JointPRS_SDPRX_${pop2}_${GWAS_type}_${i}_repeat${rpt}" >> $job_file
fi

output_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_${i}_repeat${rpt}_${pop}_linear_weights_approx${approx}.txt"
...
if [[ ! -e ${output_file} ]]; then
    echo "module load miniconda; conda activate py_env; cd /gpfs/gibbs/pi/zhao/lx94/SWIFT/; python /gpfs/gibbs/pi/zhao/lx94/SWIFT/method/MIXPRS/MIX_linear_weight.py --ref_dir=/gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ref_data/PRScsx/1kg --sst_file=data/summary_data/subsample/MIX/${trait}_prune_snplist_${i}_${pop}_tune_MIX_approx${approx}_ratio3.00_repeat${rpt}.txt --pop=${pop} --prs_beta_file=result/summary_result/JointPRS/${trait}_EUR_EAS_subAFR_JointPRS_${GWAS_type}_${i}_approx${approx}_repeat${rpt}_beta_${pop2}.txt,result/summary_result/SDPRX/${trait}_${pop1}_${pop2}_SDPRX_${GWAS_type}_${i}_approx${approx}_repeat${rpt}_beta_${pop2}.txt --indep_approx=${approx} --selection_criterion=${selection_criterion} --non_negative_weights=${non_negative_weights} --out_dir=result/summary_result/Final_weight/no_val --out_name=${trait}_JointPRS_SDPRX_${pop2}_${GWAS_type}_${i}_repeat${rpt}" >> $job_file
fi
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_3_linear_weights_full_vs_prune.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_prune_Binary_3_linear_weights_full_vs_prune-$(date +%Y-%m-%d).sh

job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_2_linear_weights_full_vs_prune.txt"
> $job_file  # Empty the job file if it already exists
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_2_linear_weights_full_vs_prune.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_prune_Binary_2_linear_weights_full_vs_prune-$(date +%Y-%m-%d).sh


## Step2: Obtain final MIXPRS weight
job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_3_MIXPRS_linear_weights_full_vs_prune.txt"
> $job_file  # Empty the job file if it already exists
...
weight_file1="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_repeat1_${pop}_linear_weights_approx${approx}.txt"
weight_file2="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_repeat2_${pop}_linear_weights_approx${approx}.txt"
weight_file3="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_repeat3_${pop}_linear_weights_approx${approx}.txt"
weight_file4="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_repeat4_${pop}_linear_weights_approx${approx}.txt"
...
weight_file1="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_${i}_repeat1_${pop}_linear_weights_approx${approx}.txt"
weight_file2="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_${i}_repeat2_${pop}_linear_weights_approx${approx}.txt"
weight_file3="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_${i}_repeat3_${pop}_linear_weights_approx${approx}.txt"
weight_file4="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_JointPRS_SDPRX_EUR_EAS_AFR_${GWAS_type}_${i}_repeat4_${pop}_linear_weights_approx${approx}.txt"
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_3_MIXPRS_linear_weights_full_vs_prune.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_prune_Binary_3_MIXPRS_linear_weights_full_vs_prune-$(date +%Y-%m-%d).sh


job_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_2_MIXPRS_linear_weights_full_vs_prune.txt"
> $job_file  # Empty the job file if it already exists
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/real_data/method/Final_weight/subsample_prune_Binary_2_MIXPRS_linear_weights_full_vs_prune.txt --partition=scavenge,day --requeue --mem=30G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
sbatch dsq-subsample_prune_Binary_2_MIXPRS_linear_weights_full_vs_prune-$(date +%Y-%m-%d).sh
