...
if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/MIXPRS/UKB_${trait}_MIXPRS_${GWAS_type}_linear_weights_approx${approx}_prs_${pop2}.sscore" ]]; then
        sbatch <<EOT
#!/bin/bash
...
#SBATCH --job-name=PRS_${trait}_MIXPRS_${GWAS_type}_linear_weights_approx${approx}_prs_${pop2}
#SBATCH --output=out_PRS_${trait}_MIXPRS_${GWAS_type}_linear_weights_approx${approx}_prs_${pop2}.txt
...
--double-id \
--threads 1 \
--score /gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/Final_weight/no_val/${trait}_${GWAS_type}_linear_weights_approx${approx}_${pop2}_MIXPRS.txt \
--out UKB_${trait}_MIXPRS_${GWAS_type}_linear_weights_approx${approx}_prs_${pop2}
