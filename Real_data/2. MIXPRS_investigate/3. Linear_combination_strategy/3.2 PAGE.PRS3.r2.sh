...
trait_list = c("Height","BMI","SBP","DBP","PLT")
n_trait = length(trait_list)
trait_type_list = c(rep("PAGE",5))
...
write.table(prs_table,paste0("/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/evaluation/PAGE_MIX_prune_PRS_r2_Linear_vs_NNLS.csv"),quote=F,sep='\t',row.names=F,col.names=T)