...
output_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/clinicalPRS/${trait}/MIXPRS_plus/${trait}_JointPRS_SDPRX_SBayesRC_clinic_${pop1}_${pop2}_${GWAS_type}_repeat${rpt}_${pop}_${weight_name}.txt"

if [[ ! -e ${output_file} ]]; then
    echo "module load miniconda; conda activate py_env; cd /gpfs/gibbs/pi/zhao/lx94/SWIFT/; python /gpfs/gibbs/pi/zhao/lx94/SWIFT/method/MIXPRS/MIX_linear_weight.py --ref_dir=/gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ref_data/PRScsx/1kg --sst_file=data/summary_data/subsample/MIX/${trait}_full_snplist_${pop}_tune_MIX_approx${approx}_ratio3.00_repeat${rpt}.txt --pop=${pop} --prs_beta_file=result/summary_result/JointPRS/${trait}_${pop1}_${pop2}_JointPRS_${GWAS_type}_repeat${rpt}_beta_${pop1}.txt,result/summary_result/JointPRS/${trait}_${pop1}_${pop2}_JointPRS_${GWAS_type}_repeat${rpt}_beta_${pop2}.txt,result/summary_result/SDPRX/${trait}_${pop1}_${pop2}_SDPRX_${GWAS_type}_repeat${rpt}_beta_${pop1}.txt,result/summary_result/SDPRX/${trait}_${pop1}_${pop2}_SDPRX_${GWAS_type}_repeat${rpt}_beta_${pop2}.txt,result/summary_result/clinicalPRS/${trait}/SBayesRC/${trait}_${pop1}_inter_SBayesRC_sbrc.txt,result/summary_result/clinicalPRS/${trait}/SBayesRC/subsample/${trait}_full_snplist_${pop2}_${data_type}_SBayesRC_repeat${rpt}_sbrc.txt,/gpfs/gibbs/pi/zhao/lx94/SWIFT/data/PGS_data/CAD/CAD_hg19_META_PGS003725_inter_plink.txt --indep_approx=${approx} --out_dir=result/summary_result/clinicalPRS/${trait}/MIXPRS_plus --out_name=${trait}_JointPRS_SDPRX_SBayesRC_clinic_EUR_EAS_${GWAS_type}_repeat${rpt}" >> $job_file
fi
...
ClinicalPRS="/gpfs/gibbs/pi/zhao/lx94/SWIFT/data/PGS_data/CAD/CAD_hg19_META_PGS003725_inter_plink.txt"

weight_file1="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/clinicalPRS/${trait}/MIXPRS_plus/${trait}_JointPRS_SDPRX_SBayesRC_clinic_EUR_EAS_${GWAS_type}_repeat1_${pop}_${weight_name}.txt"
weight_file2="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/clinicalPRS/${trait}/MIXPRS_plus/${trait}_JointPRS_SDPRX_SBayesRC_clinic_EUR_EAS_${GWAS_type}_repeat2_${pop}_${weight_name}.txt"
weight_file3="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/clinicalPRS/${trait}/MIXPRS_plus/${trait}_JointPRS_SDPRX_SBayesRC_clinic_EUR_EAS_${GWAS_type}_repeat3_${pop}_${weight_name}.txt"
weight_file4="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/summary_result/clinicalPRS/${trait}/MIXPRS_plus/${trait}_JointPRS_SDPRX_SBayesRC_clinic_EUR_EAS_${GWAS_type}_repeat4_${pop}_${weight_name}.txt"
...
--sst_file=${sst_file} \
--pop=${pop} \
--prs_beta_file=${JointPRS_EUR},${JointPRS_EAS},${SDPRX_EUR},${SDPRX_EAS},${SBayesRC_EUR},${SBayesRC_EAS},${ClinicalPRS} \
