...
JointPRS_EUR="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/JointPRS/sim${sim_i}_p${p}_rho${rhog}_${sample2}_JointPRS_beta_EUR.txt"
JointPRS_EAS="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/JointPRS/sim${sim_i}_p${p}_rho${rhog}_${sample2}_JointPRS_beta_EAS.txt"
JointPRS_AFR="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/JointPRS/sim${sim_i}_p${p}_rho${rhog}_${sample2}_JointPRS_beta_AFR.txt"
JointPRS_SAS="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/JointPRS/sim${sim_i}_p${p}_rho${rhog}_${sample2}_JointPRS_beta_SAS.txt"
JointPRS_AMR="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/JointPRS/sim${sim_i}_p${p}_rho${rhog}_${sample2}_JointPRS_beta_AMR.txt"

SDPRX_EUR="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/SDPRX/sim${sim_i}_p${p}_rho${rhog}_${sample2}_EUR_${subpop}_beta_EUR.txt"
SDPRX_EAS="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/SDPRX/sim${sim_i}_p${p}_rho${rhog}_${sample2}_EUR_EAS_beta_EAS.txt"
SDPRX_AFR="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/SDPRX/sim${sim_i}_p${p}_rho${rhog}_${sample2}_EUR_AFR_beta_AFR.txt"
SDPRX_SAS="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/SDPRX/sim${sim_i}_p${p}_rho${rhog}_${sample2}_EUR_SAS_beta_SAS.txt"
SDPRX_AMR="/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/bind_chromosome/SDPRX/sim${sim_i}_p${p}_rho${rhog}_${sample2}_EUR_AMR_beta_AMR.txt"
...
sst_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/data/sim_data/summary_data/discover/MIX/${subpop}_sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_${sample_size}_MIX_real_all.txt"
