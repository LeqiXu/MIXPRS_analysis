...
write.table(sumstat_data,paste0("/gpfs/gibbs/pi/zhao/lx94/SWIFT/data/sim_data/summary_data/discover/PRScsx/", pop,"_sim",sim_i, "_h2", h2, "_p", p, "_rhog", rhog, "_", sample_size, "_PRScsx_real_prune.txt"),quote=F,sep='\t',row.names=F,col.names=T)
...
# sample size
if [[ "${subpop}" == "EAS" && "${sample2}" == "15K" ]]; then
  sample_size1=311600; sample_size2=11250;  sample_size3=15000; sample_size4=15000; sample_size5=15000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_subEAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "EAS" && "${sample2}" == "80K" ]]; then
  sample_size1=311600; sample_size2=60000;  sample_size3=80000; sample_size4=80000; sample_size5=80000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_subEAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "AFR" && "${sample2}" == "15K" ]]; then
  sample_size1=311600; sample_size2=15000; sample_size3=11250;  sample_size4=15000; sample_size5=15000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_subAFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "AFR" && "${sample2}" == "80K" ]]; then
  sample_size1=311600; sample_size2=80000; sample_size3=60000;  sample_size4=80000; sample_size5=80000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_subAFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "SAS" && "${sample2}" == "15K" ]]; then
  sample_size1=311600; sample_size2=15000; sample_size3=15000; sample_size4=11250;  sample_size5=15000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_subSAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "SAS" && "${sample2}" == "80K" ]]; then
  sample_size1=311600; sample_size2=80000; sample_size3=80000; sample_size4=60000;  sample_size5=80000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_subSAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "AMR" && "${sample2}" == "15K" ]]; then
  sample_size1=311600; sample_size2=15000; sample_size3=15000; sample_size4=15000; sample_size5=11250;  out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_subAMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "AMR" && "${sample2}" == "80K" ]]; then
  sample_size1=311600; sample_size2=80000; sample_size3=80000; sample_size4=80000; sample_size5=60000;  out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_subAMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
else
  echo "Please provide a valid subpop: EUR, EAS, AFR, SAS, or AMR, and sample2 as 15K or 80K."
fi
...
for pop in EUR EAS AFR SAS AMR; do
  if [[ "$pop" == "$subpop" ]]; then
    ...
    if [[ "$pop" == "EUR" ]]; then
        file="data/sim_data/summary_data/discover/PRScsx/${pop}_sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_${sample1}_PRScsx_real_${type_original}.txt"
    else
        file="data/sim_data/summary_data/discover/PRScsx/${pop}_sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_${sample2}_PRScsx_real_${type_original}.txt"
    fi
  fi
...
dsq --job-file /gpfs/gibbs/pi/zhao/lx94/SWIFT/code/simulation/PRS/JointPRS_scenario2_${subpop}.txt --partition=scavenge,day,week --requeue --mem=10G --cpus-per-task=1 --ntasks=1 --nodes=1 --time=24:00:00 --mail-type=ALL
