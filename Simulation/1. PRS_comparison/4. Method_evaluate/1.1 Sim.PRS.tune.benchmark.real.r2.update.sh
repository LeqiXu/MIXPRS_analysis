...
for (sample2_train in c("15K","80K")){

    sample2_val = "10K"
    sub_prs_table = data.table(n = c(sim_i), pop = c(pop), p = c(p), rhog = c(rhog), sample2 = c(sample2_train),
    ...
    test_MIXPRS_5 = fread(paste0("/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/MIXPRS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_MIXPRS_",type,"_prs_",pop,".sscore"))
    test_MIXPRS_5 = test_MIXPRS_5[match(test_pheno_id,test_MIXPRS_5$IID),]

    # SDPRX_2
    test_SDPRX_2 = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/SDPRX/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_EUR_",pop,"_beta_",pop,"_prs_",pop,".sscore"))
    test_SDPRX_2 = test_SDPRX_2[match(test_pheno_id,test_SDPRX_2$IID),]

    # XPASS_2
    test_XPASS_2 = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/XPASS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_XPASS_EUR_",pop,"_beta_",pop,"_prs_",pop,".sscore"))
    ...
    test_JointPRS_5_EUR = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/JointPRS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_JointPRS_beta_EUR_prs_",pop,".sscore"))
    test_JointPRS_5_EUR = test_JointPRS_5_EUR[match(test_pheno_id,test_JointPRS_5_EUR$IID),]

    test_JointPRS_5_EAS = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/JointPRS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_JointPRS_beta_EAS_prs_",pop,".sscore"))
    test_JointPRS_5_EAS = test_JointPRS_5_EAS[match(test_pheno_id,test_JointPRS_5_EAS$IID),]
                                                    
    test_JointPRS_5_AFR = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/JointPRS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_JointPRS_beta_AFR_prs_",pop,".sscore"))
    test_JointPRS_5_AFR = test_JointPRS_5_AFR[match(test_pheno_id,test_JointPRS_5_AFR$IID),]

    test_JointPRS_5_SAS = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/JointPRS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_JointPRS_beta_SAS_prs_",pop,".sscore"))
    test_JointPRS_5_SAS = test_JointPRS_5_SAS[match(test_pheno_id,test_JointPRS_5_SAS$IID),]
                                                    
    test_JointPRS_5_AMR = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/JointPRS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_JointPRS_beta_AMR_prs_",pop,".sscore"))
    test_JointPRS_5_AMR = test_JointPRS_5_AMR[match(test_pheno_id,test_JointPRS_5_AMR$IID),]

    test_JointPRS_5 = fread(paste0("/vast/palmer/pi/zhao/yd357/MIXPRS_Revise/Project1_15K_80K/result/add_benchmark/25.10.4/sim_data/prs_scores/JointPRS/sim",sim_i,"_p",p,"_rho",rhog,"_",sample2_train,"_JointPRS_beta_",pop,"_prs_",pop,".sscore"))
...
write.table(prs_table,paste0("/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/evaluation/sim_PRS_real_tune_benchmark_r2_update.csv"),quote=F,sep='\t',row.names=F,col.names=T)