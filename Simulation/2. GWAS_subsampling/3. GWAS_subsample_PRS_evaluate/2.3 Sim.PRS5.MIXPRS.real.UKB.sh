...
# JointPRS_name
if [[ "${subpop}" == "EUR" ]]; then
  JointPRS_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_subEUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
...
if [[ "${subpop}" == "EUR" ]]; then
    sample_size="${sample1}"
    EUR_SDPRX_prs_beta="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/subsample/SDPRX/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_subEUR_EAS_${sample1}_${sample2}_SDPRX_subsample_${type}_approx${approx}_repeat${rpt}_beta_EUR.txt"
    for pop in EAS AFR SAS AMR; do
        declare "${pop}_SDPRX_prs_beta=/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/subsample/SDPRX/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_subEUR_${pop}_${sample1}_${sample2}_SDPRX_subsample_${type}_approx${approx}_repeat${rpt}_beta_${pop}.txt"
    done
else
    sample_size="${sample2}"
...
if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/Final_weight/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_SDPRX_${type}_repeat${rpt}_linear_weights_approx${approx}.txt" ]]; then
...
weight_file1="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/Final_weight/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_SDPRX_${type}_repeat1_${subpop}_linear_weights_approx${approx}.txt"
weight_file2="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/Final_weight/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_SDPRX_${type}_repeat2_${subpop}_linear_weights_approx${approx}.txt"
weight_file3="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/Final_weight/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_SDPRX_${type}_repeat3_${subpop}_linear_weights_approx${approx}.txt"
weight_file4="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/Final_weight/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_SDPRX_${type}_repeat4_${subpop}_linear_weights_approx${approx}.txt"
...
output_file="/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/MIXPRS/sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_SDPRX_${type}_linear_weights_approx${approx}_${subpop}_MIXPRS.txt"

if [[ ! -e ${output_file} ]]; then
    echo "module load miniconda; conda activate py_env; cd /gpfs/gibbs/pi/zhao/lx94/SWIFT/; python /gpfs/gibbs/pi/zhao/lx94/SWIFT/method/MIXPRS/MIX_final_combine.py --ref_dir=/gpfs/gibbs/pi/zhao/lx94/JointPRS/data/ref_data/PRScsx/1kg --sst_file=${sst_file} --pop=${subpop} --prs_beta_file=${prs_file} --weight_file=${weight_file} --indep_approx=${approx} --out_dir=/gpfs/gibbs/pi/zhao/lx94/SWIFT/result/sim_result/MIXPRS --out_name=sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_SDPRX_${type}_linear_weights_approx${approx}" >> $job_file
fi
