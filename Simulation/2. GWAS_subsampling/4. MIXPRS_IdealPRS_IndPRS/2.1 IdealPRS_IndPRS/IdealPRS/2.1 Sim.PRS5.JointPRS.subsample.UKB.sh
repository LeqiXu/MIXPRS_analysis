...
# sample size
if [[ "${subpop}" == "EUR" ]]; then
  sample_size1=233700; sample_size2=100000; sample_size3=100000; sample_size4=100000; sample_size5=100000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_subEUR_EAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "EAS" ]]; then
  sample_size1=311600; sample_size2=75000;  sample_size3=100000; sample_size4=100000; sample_size5=100000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_subEAS_AFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "AFR" ]]; then
  sample_size1=311600; sample_size2=100000; sample_size3=75000;  sample_size4=100000; sample_size5=100000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_subAFR_SAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "SAS" ]]; then
  sample_size1=311600; sample_size2=100000; sample_size3=100000; sample_size4=75000;  sample_size5=100000; out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_subSAS_AMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
elif [[ "${subpop}" == "AMR" ]]; then
  sample_size1=311600; sample_size2=100000; sample_size3=100000; sample_size4=100000; sample_size5=75000;  out_name="sim${sim_i}_h2${h2}_p${p}_rhog${rhog}_EUR_EAS_AFR_SAS_subAMR_${sample1}_${sample2}_JointPRS_subsample_${type}_approx${approx}_repeat${rpt}"
else
...
for (subpop in c("EUR","EAS","AFR","SAS","AMR")){

if (subpop == "EUR") {
  type_list=c("full_snplist_ukbb")
} else {
  type_list=c("full_snplist_100K", "full_snplist_1kg")
}

for (type in type_list){

if (subpop == "EUR") {
    out_name = paste0("sim",sim_i,"_h2",h2,"_p",p,"_rhog",rhog,"_subEUR_EAS_AFR_SAS_AMR_",sample1,"_",sample2,"_JointPRS_subsample_",type,"_approx",approx,"_repeat",rpt)
} else if (subpop == "EAS") {
